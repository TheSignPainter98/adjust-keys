...
def parse_args(args:[str]) -> Namespace:
    ...
    ap.add_argument('-O', '--glyph-offsets', action='store', dest='glyph_offset_file', help='specify the file containing offsets for each glyph from the center of a keys (default: glyphs.yaml)', default='glyphs.yml', metavar='file')
    ...
    ap.add_argument('-Q', '--profile-row-list', action='store', dest='layout_row_profile_file', help='specify the file containing the mapping from rows of the layout to their profile row', default='layout_row_profiles.yml', metavar='file')
