...
def parse_args(args:[str]) -> Namespace:
    ...
    ap.add_argument('-G', '--glyphs', action='store', dest='glyph_offset_file', help='specify the file containing offsets for each glyph from the center of a key (default: glyphs.yaml)', default='glyphs.yml', metavar='file')
